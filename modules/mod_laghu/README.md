...
`Laghu CacheMimeTypes` configures the inherited comma-separated allowlist for opaque media cache extension. It is empty by default and matches declared MIME types rather than filenames.
