...
CSS markup settings also mirror NGINX: `Laghu CssInlineLimit 0..65536`
(default 2048) and `Laghu CssOutlineThreshold 1024..1048576` (default 8192).
Small catalog-ready stylesheets may be inlined and eligible large style blocks
may be outlined to immutable `/.laghu/css/<sha256>` assets; both paths preserve
the cold response and fail open.
