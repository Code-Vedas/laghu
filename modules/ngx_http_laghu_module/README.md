...
This directory contains the thin NGINX integration layer. Shared filters belong in `libs/`, so the NGINX and Apache modules cannot drift.
...
- delegates preset/rewrite-level resolution and response eligibility, including intentional passthrough and default API exclusion, to `laghu-core`
