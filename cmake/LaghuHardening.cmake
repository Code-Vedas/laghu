...
function(laghu_configure_hardening)
  ...
  if(posix_build)
    ...
    laghu_hardening_probe(static_pic static_pic_supported COMPILE_OPTIONS -fPIC)
    ...
    set(static_pic_supported false)
  ...
  if(release_build AND posix_build)
    ...
    if(NOT static_pic_supported)
      laghu_hardening_fail("feature=static_pic; required=release_posix")
    endif()
  endif()
  ...
  set(static_position_independent_code false)
  if(release_build)
    ...
    if(posix_build AND static_pic_supported)
      set(static_position_independent_code true)
    endif()
    ...
    if(posix_build AND fortification_supported)
      list(APPEND common_compile_options -D_FORTIFY_SOURCE=3)
  ...
  set(LAGHU_HARDENING_STATIC_POSITION_INDEPENDENT_CODE "${static_position_independent_code}" CACHE INTERNAL
    "Laghu position-independent first-party static and object targets" FORCE)
