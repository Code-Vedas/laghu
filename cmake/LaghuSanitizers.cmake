...
function(laghu_validate_sanitizer_suppressions manifest source_root)
  if(NOT EXISTS "${manifest}")
    laghu_sanitizer_fail("manifest=${manifest}; file is required")
  endif()
  if(NOT IS_DIRECTORY "${source_root}")
    laghu_sanitizer_fail("source_root=${source_root}; directory is required")
  endif()
  ...
  foreach(line IN LISTS lines)
    ...
    if(target_or_source MATCHES "^src/")
      if(target_or_source MATCHES "(^|/)\\.\\.?(/|$)")
        laghu_sanitizer_fail("source=${target_or_source}; source_path_segments_forbidden")
      endif()
      if(NOT EXISTS "${source_root}/${target_or_source}")
        laghu_sanitizer_fail("source=${target_or_source}; source_file_required")
      endif()
    endif()
