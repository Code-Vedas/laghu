...
function(laghu_copy_source destination)
  ...
  endforeach()
  file(MAKE_DIRECTORY "${destination}/scripts")
  foreach(script IN ITEMS benchmark benchmark-evaluate)
    set(source_script "${LAGHU_SOURCE}/scripts/${script}")
    if(NOT EXISTS "${source_script}")
      message(FATAL_ERROR "Laghu reproducibility expectation failed: source_entry_missing=scripts/${script}")
    endif()
    file(COPY "${source_script}" DESTINATION "${destination}/scripts")
  endforeach()
endfunction()
