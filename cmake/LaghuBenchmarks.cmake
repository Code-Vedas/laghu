...
function(laghu_add_benchmark_targets)
  ...
  add_executable(laghu_benchmark_evaluate EXCLUDE_FROM_ALL bench/evaluator.cpp)
  laghu_apply_first_party_contract(laghu_benchmark_evaluate)
  target_include_directories(laghu_benchmark_evaluate PRIVATE
    "${CMAKE_BINARY_DIR}/generated")
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    # This non-installed artifact reader uses bounded POSIX file buffers and
    # C++ character-conversion ranges. Its parser validates every offset.
    set_source_files_properties(bench/evaluator.cpp PROPERTIES
      COMPILE_OPTIONS -Wno-unsafe-buffer-usage)
  endif()
...
function(laghu_add_benchmark_validation_tests)
  ...
  add_test(NAME laghu.benchmark.evaluator
    COMMAND "${CMAKE_COMMAND}"
      "-DSCRIPT=${CMAKE_SOURCE_DIR}/scripts/benchmark-evaluate"
      "-DBUILD_DIRECTORY=${CMAKE_BINARY_DIR}"
      "-DSOURCE_DIRECTORY=${CMAKE_SOURCE_DIR}"
