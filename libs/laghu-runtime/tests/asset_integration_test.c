...
static void test_asset_config_and_jobs(const laghu_test_workspace *workspace) {
  ...
  assert(laghu_test_workspace_path(workspace, "assets.conf", config_path,
                                   sizeof(config_path)));
  assert(laghu_test_workspace_path(workspace, "asset-catalog", catalog_path,
                                   sizeof(catalog_path)));
  assert(laghu_test_workspace_path(workspace, "asset-queue", asset_queue_path,
                                   sizeof(asset_queue_path)));
  ...
  assert(laghu_test_workspace_write(workspace, "assets.conf",
