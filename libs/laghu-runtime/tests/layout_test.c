...
int main(void) {
  ...
  assert(laghu_layout_reservations_apply(
      (laghu_buffer){(const unsigned char *)"<ins id=ad-slot></ins><h1 id=headline>Title</h1>",
  ...
  assert(laghu_layout_reservations_apply(
      (laghu_buffer){(const unsigned char *)"<script>var html='<ins id=ad-slot>';</script><ins data-id=ad-slot></ins><ins id=ad-slot style=\"x\"></ins>",
  ...
  assert(laghu_layout_reservations_apply(
      (laghu_buffer){(const unsigned char *)"<ins id=ad-slot></ins>", sizeof("<ins id=ad-slot></ins>") - 1U}, &rules, &csp, &result));
  assert(!result.rewritten);
