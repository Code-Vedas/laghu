...
int main(void) {
  ...
  cursor = 0U;
  CHECK(laghu_srcset_next((laghu_buffer){srcset, sizeof(srcset) - 1U}, &cursor,
                          &candidate));
