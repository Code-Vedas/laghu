...
class DeterministicEntropy final {
 public:
  ...
  [[nodiscard]] constexpr adapters::internal::EntropyCall call() const noexcept { return fill; }
 ...
 private:
  [[nodiscard]] static int fill(core::MutableByteView output, void* context) noexcept;
